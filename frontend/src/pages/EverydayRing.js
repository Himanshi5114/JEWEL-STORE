...
// Images
import ring1 from "../assets/everyday-ring1.jpg";
import ring2 from "../assets/everyday-ring2.jpg";
import ring3 from "../assets/everyday-ring3.jpg";
...
const EverydayRing = () => {
  ...
  const rings = [
    { 
      ...
      img: ring1,
      desc: "Simple gold ring for everyday elegance.",
      price: "₹2,000"
    },
    { 
      name: "Silver Pearl Ring", 
      img: ring2,
      desc: "Delicate silver ring with pearl accent, perfect for daily wear.",
      price: "₹2,500"
    },
    { 
      name: "Beaded Statement Ring", 
      img: ring3,
      desc: "Lightweight beaded ring with a subtle statement design.",
      price: "₹1,800"
    },
  ];
